(function (global, factory) {
	...
	*/
	...
	var codemirror_4 = codemirror.EditorState;
	var codemirror_5 = codemirror.Transaction;
	var codemirror_6 = codemirror.EditorView;
	var codemirror_7 = codemirror.keymap;
	var codemirror_8 = codemirror.history;
	var codemirror_9 = codemirror.redo;
	var codemirror_10 = codemirror.redoSelection;
	var codemirror_11 = codemirror.undo;
	var codemirror_12 = codemirror.undoSelection;
	var codemirror_13 = codemirror.gutter;
	var codemirror_14 = codemirror.baseKeymap;
	var codemirror_15 = codemirror.matchBrackets;
	var codemirror_16 = codemirror.specialChars;
	var codemirror_17 = codemirror.multipleSelections;
	var codemirror_18 = codemirror.legacyMode;
	...
	var historyKeymap = function () {
	    ...
	    return _a = {
	            "Mod-z": codemirror_11,
	            "Mod-Shift-z": codemirror_9,
	            "Mod-u": function (view) { return codemirror_12(view) || true; }
	        },
	        _a[isMac ? "Mod-Shift-u" : "Alt-u"] = codemirror_10,
	        _a["Ctrl-y"] = isMac ? undefined : codemirror_9,
	        _a;
	};
	...
	var experimentPlugin = new codemirror_3({
	    view: function (view) {
	...
	var mode = codemirror_18(codemirror_1({ indentUnit: 2 }, {}));
	var state = codemirror_4.create({ doc: "\"use strict\";\nconst {readFile} = require(\"fs\");\n\nreadFile(\"package.json\", \"utf8\", (err, data) => {\n  console.log(data);\n});", plugins: [
	        codemirror_13(),
	        codemirror_8(),
	        codemirror_16({}),
	        codemirror_17(),
	        mode,
	        codemirror_15({ decorationsPlugin: mode }),
	        codemirror_7(historyKeymap()),
	        codemirror_7(indentationKeymap(mode)),
	        codemirror_7(codemirror_14),
	        experimentPlugin
	    ] });
	var view = window.view = new codemirror_6(state);
